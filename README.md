...
# Deteccion de Objetos con Python
...
* **Detección Facial en Tiempo Real:** Identificación de rostros a través de la webcam.
* **Procesamiento Eficiente:** Optimizado para mantener una tasa de frames (FPS) fluida.
* **Interfaz Visual:** Recuadros delimitadores (bounding boxes) que siguen el movimiento del rostro.
